  ...
  const stats = [
    {
      ...
      value: 236,
      suffix: "+",
      label: numbers?.heading4?.text,
      description: numbers?.heading5?.text,
    ...
    },
    {
      ...
      value: 5,
      suffix: "+",
      label: numbers?.heading7?.text,
      description: numbers?.heading8?.text,
    ...
    },
    {
      ...
      value: 250,
      suffix: "+",
      label: numbers?.heading10?.text,
      description: numbers?.heading11?.text,
    ...
    },
    {
      ...
      value: 8,
      suffix: "+",
      label: numbers?.heading13?.text,
      description: numbers?.heading14?.text,
